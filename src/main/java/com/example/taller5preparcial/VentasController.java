...
public class VentasController {
    ...
    public void initialize() {
        // Establecer la fecha actual de forma automática
        ...
        // Formato para columnas numéricas: Sin .0 en enteros, dos decimales en otros.
        ...
        // 2. LISTENERS para cálculo dinámico
        // Llama a actualizarDetalles cada vez que se selecciona un producto o se cambia la cantidad
    ...
    // Método auxiliar para el formato de la tabla (similar a ProductosController)
        ...
        return new TableCell<Venta, Number>() {
            ...
            protected void updateItem(Number item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    if (valor == Math.floor(valor) && valor < 1_000_000) { // Limitamos para números grandes
                        setText(String.format("%.0f", valor));
                    } else {
                        setText(String.format("%,.2f", valor)); // Formato con separador de miles y 2 decimales
                    }
                }
            }
        };
    ...
    // Método para recibir los datos principales del DashboardController
    public void initData(ObservableList<Cliente> clientes, ObservableList<Producto> productos, ObservableList<Venta> ventas) {
        ...
        // Cargar nombres de Clientes al ComboBox usando Stream API
        cmbCliente.setItems(
        ...
        // Cargar nombres de Productos al ComboBox usando Stream API
    ...
    // Se ejecuta al cambiar producto o cantidad
    private void actualizarDetalles() {
        ...
        try {
            ...
            // Si el texto no es un número válido, la cantidad es 0
        }
    ...
    private void guardarVenta() {
        ...
        if (cliente != null && producto != null && cantidad > 0) {
            ...
            // Re-obtener el precio para asegurar consistencia
